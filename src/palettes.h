void Palette(int palette, int iter, int *r, int *g, int *b)
{
  ...
  static int JuteBlue[256][3]={
    {140, 148, 204}, {144, 152, 208}, {140, 148, 204}, {136, 144, 204},
  ...
  static int JuteMap[256][3]={
    { 98,  98, 188}, { 88,  88, 184}, { 96,  92, 192}, {104, 100, 192},
  ...
  static int Jute[256][3]={
    {  0,  84,   0}, {  0,  72,   0}, {  0, 108,   0}, {  0, 144,   0},
  ...
  static int MandelbrotMap[256][3]={
    {216, 216, 216}, {224, 224, 224}, {216, 216, 216}, {208, 208, 208},
  ...
  static int Rose[256][3]={
    {124, 198, 208}, {124, 192, 208}, {124, 196, 208}, {124, 204, 208},
  ...
  *red = (*p)[iterations][0];              // Select and pass color components
  *green = (*p)[iterations][1];
  *blue = (*p)[iterations][2];
}
